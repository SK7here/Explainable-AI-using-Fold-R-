...
def main():
    ...
    # model, data = iris()
    # model, data = employee()
    # model, data = travel_insurance()
    # model, data = telecom_churn()
    # model, data_train, data_test = customer_segmentation()
    # model, data = water_quality()
    # model, data = diabetes()
    # model, data = stress()
    ...
    start = timer()
    model.fit(X_train, Y_train, ratio=0.7)  
